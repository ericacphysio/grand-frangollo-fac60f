        ...
        <div className="container">
          ...
          <section className="service-category">
            ...
            <article className="service">
              ...
              <p>
                Build a stronger, more capable body through personalised
                exercise.
              </p>

              <p>
                Your program can be tailored to your abilities and
          ...
          <section className="service-category">
            ...
            <p>
              Pain can affect how you move, how you sleep, how you work, and
              how you participate in the things you enjoy.
            </p>

            <p>
              At Ace Body Physiotherapy &amp; Wellness, we use a combination
              of manual therapy, exercise, education, and pain-management
              strategies to help you manage your symptoms and improve your
              movement.
            </p>
            ...
            <article className="service">
              ...
              <p>
                Our physiotherapists provide hands-on treatment where
                appropriate to help:
              </p>
            ...
            <article className="service">
              ...
              <p>
                Dry needling uses fine, sterile needles to target specific
                muscles and areas of muscular tension.
              </p>

              <p>
                It may be incorporated into your treatment plan to assist
                with the management of muscle pain, tightness, and movement
                restrictions.
              </p>

              <p>
                Your physiotherapist will assess whether dry needling is
                appropriate for you and discuss the treatment with you
                beforehand.
              </p>
            </article>
          </section>
          ...
          <section className="service-category">
            ...
            <p>
              Physiotherapy isn't only about recovering from an injury.
              Maintaining your physical capabilities can help you stay
              active, independent, and confident in your everyday life.
            </p>
            ...
            <article className="service">
              ...
              <p>
                Our falls prevention programs focus on improving your ability
                to move safely and confidently through:
              </p>
              ...
              <p>
                Whether you've experienced a fall or simply feel less steady
                on your feet, we can help you work towards greater strength,
          ...
          <section className="our-approach">
            ...
            <article className="approach-step">
              ...
              <p>
                We listen to your concerns, understand your history, assess
                your movement, and identify what is affecting your ability
            ...
            <article className="approach-step">
              ...
              <p>
                ...
                needling, exercise, mobility work, and pain-management
                strategies.
              </p>
            </article>
            ...
            <article className="approach-step">
              <h3>
                <span>03</span> — Rehabilitate
              </h3>

              <p>
                We develop a personalised program to progressively improve
                your strength, mobility, balance, and physical function.
              </p>
            </article>

            <article className="approach-step">
              <h3>
                <span>04</span> — Empower
              </h3>
